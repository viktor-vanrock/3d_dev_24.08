...
@Controller() export class AppealsController {
  ...
  @Post("sanctions/:id/appeals") @HttpCode(201) @ApiSanctionOperation("Submit a sanction appeal", "appeal", "id")
  ...
  @Get("sanctions/:id/appeals") @ApiSanctionOperation("List sanction appeals", "appeal-list", "id")
  ...
  @Post("appeals/:id/resolve") @HttpCode(200) @ApiSanctionOperation("Resolve a sanction appeal", "appeal", "id")
