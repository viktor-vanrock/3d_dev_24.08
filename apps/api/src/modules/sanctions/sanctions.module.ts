...
@Global()
@Module({ imports: [DatabaseModule], controllers: [SanctionsController, AppealsController], providers: [SanctionsRepository, SanctionsService, AppealsService, SanctionRelayOutboxDispatcher, SanctionsExpirationService, { provide: SANCTIONS_READ_PORT, useExisting: SanctionsRepository }, { provide: SANCTIONS_PORT, useExisting: SanctionsService }, { provide: SANCTION_APPEALS_PORT, useExisting: AppealsService }, { provide: SANCTIONS_RELAY_DISPATCH_PORT, useExisting: SanctionRelayOutboxDispatcher }, { provide: SANCTIONS_EXPIRATION_PORT, useExisting: SanctionsExpirationService }], exports: [SANCTIONS_READ_PORT, SANCTIONS_PORT, SANCTION_APPEALS_PORT, SANCTIONS_RELAY_DISPATCH_PORT, SANCTIONS_EXPIRATION_PORT] })
